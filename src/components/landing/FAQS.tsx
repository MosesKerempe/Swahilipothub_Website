...
export default function FAQS() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "No, SwahiliPot Hub is for everyone interested in innovation and creativity. While we have strong technology programs, we also focus on arts, culture, and community development. We believe in the power of interdisciplinary collaboration.",
    },
    {
      question: "How can I support SwahiliPot Hub?",
      answer:
        "You can support us by volunteering, becoming a mentor, partnering with us on projects, sponsoring our programs, or making a donation. Every contribution helps us expand our impact and reach more youth in East Africa.",
    },
    {
        ...
        <div className="max-w-3xl mx-auto">
          {faqs.map((faq, index) => (
            <div key={index} className="mb-4">
              <button
                className="flex justify-between items-center w-full p-5 bg-blue-100 rounded-lg hover:bg-blue-200 transition-colors"
